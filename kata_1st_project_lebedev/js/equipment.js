...
(function () {
  ...
  const swiperEl = section.querySelector('.equipment-swiper');
  ...
  function getSlides() {
    return [...section.querySelectorAll('.equipment-swiper .swiper-slide')];
  }
  ...
  function updateExpandButton(total, limit) {
    ...
    btn.classList.toggle('equipment-expand--open', expanded);
  }
  ...
  function applyCollapse() {
    ...
    const pagEl = section.querySelector('.equipment-swiper__bullets');
    if (pagEl) {
      pagEl.classList.remove('equipment-swiper__pagination--off');
    }
    updateExpandButton(total, limit);
  }

  function setGridMode(isGrid) {
    section.classList.toggle('equipment-section--grid', isGrid);
  }
  ...
  function extractSlidesForMobile() {
    ...
    while (wrapper.children.length > MOBILE_SLIDE_COUNT) {
      ...
      mobileOverflowFragment.insertBefore(
        last,
        mobileOverflowFragment.firstChild,
      );
    }
  }
  ...
  function initSwiper() {
    ...
    swiper = new Swiper(swiperEl, {
      ...
      observeParents: true,
      pagination: {
        el: section.querySelector('.equipment-swiper__bullets'),
        clickable: true,
